...
import OicSidebar from './OicSidebar.jsx';
import OicHeader from './OicHeader.jsx';

export default function OicLayout({ currentUser, onLogout }) {
  ...
  return (
    <>
      ...
      <div className={`oic-shell ${sidebarCollapsed ? 'collapsed' : ''}`}>
        <OicSidebar
