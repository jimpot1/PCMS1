...
import RecommendingApproverSidebar from './RecommendingApproverSidebar.jsx';
import RecommendingApproverHeader from './RecommendingApproverHeader.jsx';

export default function RecommendingApproverLayout({ currentUser, onLogout }) {
