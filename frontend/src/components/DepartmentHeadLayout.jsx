...
import DepartmentHeadHeader from './DepartmentHeadHeader.jsx';

export default function DepartmentHeadLayout({ currentUser, onLogout }) {
  ...
  return (
    <>
      ...
      <div className="department-dashboard-shell">
        ...
        <div className="department-main-panel">
          ...
          />
          <main className="department-content-area">
            <Outlet />
          </main>
        </div>
      </div>
